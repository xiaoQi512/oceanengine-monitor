// tests/five-min-context.test.mjs - 领域层 5min 上下文测试
import assert from 'node:assert';
import { buildDetailedCardContext } from '../src/domain/five-min-context.mjs';
...
assert.strictEqual(ctx.pm2Prefix, '[domain]');
