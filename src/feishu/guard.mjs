// src/feishu/guard.mjs — 飞书推送的统一熔断/超时/成本守卫
...
import { Provider, AutonomousRouter } from '../utils/autonomous-router.mjs';
import { FEISHU_CHAT_ID, PROJECT_ROOT, atomicWriteJSON, DATA_DIR } from '../utils/monitor-utils.mjs';
...
// 便捷包装：文件消息
export async function pushFile(larkCmd, filePath, chatId = FEISHU_CHAT_ID, cwd = PROJECT_ROOT, options = {}) {
