...
export function serveSnapshotTrend(url, req, res, ctx) {
  ...
  try {
    ...
    res.end(JSON.stringify({ error: e.message, baseSpend: 0, baseConversions: 0, baseImpressions: 0, baseClicks: 0, labels: [], timestamps: [], spend: [], cpl: [], cpm: [], conversions: [], impressions: [], clicks: [], activeCount: [], planSpend: [], spendingCount: [], deliveringCount: [], totalPlanCount: 0, pausedPlanCount: 0, convBreakdown: [], top5PerPoint: [], top5_15m: [] }));
  }
  return true;
}
