...
## v2.1.0 — Dashboard v4 封版（2026-08-04）

**仪表盘正式切换为 v4**
- `/dashboard` 与 `/dashboard-v4` 均指向 `dashboard-v4.html`
- 旧版 v1/v2/v3 归档至 `archive/dashboard-legacy-20260804/`，`/dashboard-v2` 保留回退
- PWA 缓存本地 Chart.js，移除旧 CDN 依赖

**核心能力**
- 概览：实时 KPI、昨日对比、趋势图、主播班次明细、补推、需要处理快捷操作
- 投放计划：全部计划/未投放计划子页，预算使用率与预警
- 操作中心：队列、待确认、审计、回滚
- AI 建议：规则、异常计划、效果追踪
